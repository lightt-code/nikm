...
// Interactive 3D business card â one pointer system for mouse, pen and touch.
...
if (cardReset) cardReset.addEventListener('click', () => {
  targetX = -8;
  targetY = 16;
});
...
function renderDots() {
  slides.forEach((_, index) => {
    ...
    dot.setAttribute('aria-label', `ÐÐ¾ÐºÐ°Ð·Ð°ÑÑ ÑÐ°Ð±Ð¾ÑÑ ${index + 1}`);
